...
class AnimatedCircle extends CustomPainter {
  ...
  AnimatedCircle({
    ...
    required this.showOnLargeCirlce,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (showOnxSmallCircle) {
      ...
      double valY = y(110, sAngle, centerY);
...
// in the above equation we are converting polar co-ordinates into cartesian coordinates
// polar co-ordinates are usually in the form of (radius, theta) and cartesian coordinates are (x, y)
/*
we use the following formula to convert the polar equation to cartesian coordinates
x = r.cos(theta)
y = r.sin(theta)
we are subtracting pi/2 to align the circle in the positive x-axis since in polar alignment is usually in positive y-axis
we then add centerX and centerY to the total equation to transform the circle and align it with center (0, 0)
*/
